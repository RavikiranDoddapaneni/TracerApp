            ...
            if (noOfRecords > 0) {
              while (cursor.moveToNext()) {
                ...
                if (offlineCAFresponse != null) {
                  InputStream in = offlineCAFresponse.getEntity().getContent(); // Get the
                  BufferedReader rd = new BufferedReader(new InputStreamReader(in));
                  String line;
                  ...
                  while ((line = rd.readLine()) != null) {
                    ...
                    if (cafResponse.equals("ok")) {
                      dataBaseHelper.deleteRecordsInDB("caf_collection_details", "caf_collection_id=?", new String[] { String.valueOf(cursor.getInt(0)) });
                    }
                  }
                  rd.close();
                }
